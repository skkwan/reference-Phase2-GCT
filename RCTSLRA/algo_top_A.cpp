...
void processInputLinks_A(ap_uint<384> link_in[N_INPUT_LINKS], crystal ECALRegion3x4_1[CRYSTAL_IN_ETA][CRYSTAL_IN_PHI], crystal ECALRegion3x4_2[CRYSTAL_IN_ETA][CRYSTAL_IN_PHI],crystal ECALRegion3x4_3[CRYSTAL_IN_ETA][CRYSTAL_IN_PHI]){
...
ecalRegion_t initStructure_A(crystal temporary[CRYSTAL_IN_ETA][CRYSTAL_IN_PHI]){
...
ecaltp_t bestOf2_A(const ecaltp_t& ecaltp0, const ecaltp_t& ecaltp1) {
        ecaltp_t x;
...
ecaltp_t getPeakBin20N_A(const etaStrip_t& etaStrip){
//#pragma HLS PIPELINE II=2
#pragma HLS latency min=4

ecaltp_t best01 = bestOf2_A(etaStrip.cr0,etaStrip.cr1) ;
ecaltp_t best23 = bestOf2_A(etaStrip.cr2,etaStrip.cr3) ;
ecaltp_t best45 = bestOf2_A(etaStrip.cr4,etaStrip.cr5) ;
ecaltp_t best67 = bestOf2_A(etaStrip.cr6,etaStrip.cr7) ;
ecaltp_t best89 = bestOf2_A(etaStrip.cr8,etaStrip.cr9) ;
ecaltp_t best1011 = bestOf2_A(etaStrip.cr10,etaStrip.cr11) ;
ecaltp_t best1213 = bestOf2_A(etaStrip.cr12,etaStrip.cr13) ;
ecaltp_t best1415 = bestOf2_A(etaStrip.cr14,etaStrip.cr15) ;
ecaltp_t best1617 = bestOf2_A(etaStrip.cr16,etaStrip.cr17) ;
ecaltp_t best1819 = bestOf2_A(etaStrip.cr18,etaStrip.cr19) ;

ecaltp_t best0123 = bestOf2_A(best01,best23) ;
ecaltp_t best4567 = bestOf2_A(best45,best67) ;
ecaltp_t best891011 = bestOf2_A(best89,best1011) ;
ecaltp_t best12131415 = bestOf2_A(best1213,best1415) ;
ecaltp_t best16171819 = bestOf2_A(best1617,best1819) ;

ecaltp_t best01234567 = bestOf2_A(best0123,best4567) ;
ecaltp_t best89101112131415 = bestOf2_A(best891011,best12131415) ;

ecaltp_t best0to15 = bestOf2_A(best01234567,best89101112131415) ;
ecaltp_t bestOf20 = bestOf2_A(best0to15,best16171819) ;
...
ecaltp_t best01 = bestOf2_A(etaStrip.pk0,etaStrip.pk1) ;
ecaltp_t best23 = bestOf2_A(etaStrip.pk2,etaStrip.pk3) ;
ecaltp_t best45 = bestOf2_A(etaStrip.pk4,etaStrip.pk5) ;
ecaltp_t best67 = bestOf2_A(etaStrip.pk6,etaStrip.pk7) ;
ecaltp_t best89 = bestOf2_A(etaStrip.pk8,etaStrip.pk9) ;
ecaltp_t best1011 = bestOf2_A(etaStrip.pk10,etaStrip.pk11) ;
ecaltp_t best1213 = bestOf2_A(etaStrip.pk12,etaStrip.pk13) ;

ecaltp_t best0123 = bestOf2_A(best01,best23) ;
ecaltp_t best4567 = bestOf2_A(best45,best67) ;
ecaltp_t best891011 = bestOf2_A(best89,best1011) ;
ecaltp_t best121314 = bestOf2_A(best1213,etaStrip.pk14) ;

ecaltp_t best01234567 = bestOf2_A(best0123,best4567);
ecaltp_t best891011121314 = bestOf2_A(best891011,best121314) ;

ecaltp_t bestOf15 = bestOf2_A(best01234567,best891011121314) ;
...
void getTowerEt_A(crystal tempX[CRYSTAL_IN_ETA][CRYSTAL_IN_PHI], ap_uint<12> towerEt[12]){
        #pragma HLS PIPELINE II=6
        #pragma HLS latency min=4
...
#pragma HLS latency min=4
        ...
        clusterInfo cluster ;
                ...
                etaStripPeak.pk0 = getPeakBin20N_A(ecalRegion.etaStrip0);
                etaStripPeak.pk1 = getPeakBin20N_A(ecalRegion.etaStrip1);
                etaStripPeak.pk2 = getPeakBin20N_A(ecalRegion.etaStrip2);
                etaStripPeak.pk3 = getPeakBin20N_A(ecalRegion.etaStrip3);
                etaStripPeak.pk4 = getPeakBin20N_A(ecalRegion.etaStrip4);
                etaStripPeak.pk5 = getPeakBin20N_A(ecalRegion.etaStrip5);
                etaStripPeak.pk6 = getPeakBin20N_A(ecalRegion.etaStrip6);
                etaStripPeak.pk7 = getPeakBin20N_A(ecalRegion.etaStrip7);
                etaStripPeak.pk8 = getPeakBin20N_A(ecalRegion.etaStrip8);
                etaStripPeak.pk9 = getPeakBin20N_A(ecalRegion.etaStrip9);
                etaStripPeak.pk10 = getPeakBin20N_A(ecalRegion.etaStrip10);
                etaStripPeak.pk11 = getPeakBin20N_A(ecalRegion.etaStrip11);
                etaStripPeak.pk12 = getPeakBin20N_A(ecalRegion.etaStrip12);
                etaStripPeak.pk13 = getPeakBin20N_A(ecalRegion.etaStrip13);
                etaStripPeak.pk14 = getPeakBin20N_A(ecalRegion.etaStrip14);
...
void RemoveTmp_A(crystal temp[CRYSTAL_IN_ETA][CRYSTAL_IN_PHI], ap_uint<5> seed_eta,  ap_uint<5> seed_phi, ap_uint<2> brems  ){
#pragma HLS ARRAY_PARTITION variable=temp complete dim=0
...
clusterInfo getBremsValuesPos_A(crystal tempX[CRYSTAL_IN_ETA][CRYSTAL_IN_PHI], ap_uint<5> seed_eta,  ap_uint<5> seed_phi ){
#pragma HLS ARRAY_PARTITION variable=tempX complete dim=0
...
clusterInfo getBremsValuesNeg_A(crystal tempX[CRYSTAL_IN_ETA][CRYSTAL_IN_PHI], ap_uint<5> seed_eta,  ap_uint<5> seed_phi ){
#pragma HLS ARRAY_PARTITION variable=tempX complete dim=0
#pragma HLS latency min=6
...
clusterInfo getClusterValues_A(crystal tempX[CRYSTAL_IN_ETA][CRYSTAL_IN_PHI], ap_uint<5> seed_eta,  ap_uint<5> seed_phi ){
#pragma HLS ARRAY_PARTITION variable=tempX complete dim=0
#pragma HLS latency min=6
...
Cluster getRegion3x4_A(crystal temp[CRYSTAL_IN_ETA][CRYSTAL_IN_PHI], ap_uint<5> eta_offset){
#pragma HLS ARRAY_PARTITION variable=temp complete dim=0
//#pragma HLS PIPELINE II=2
...
ecalRegion_t ecalRegion;
        ...
        ecalRegion = initStructure_A(temp) ;
        ...
        cluster_tmpCenter = getClusterValues_A(temp, seed_eta, seed_phi) ;
        cluster_tmpBneg = getBremsValuesNeg_A(temp, seed_eta, seed_phi) ;
        cluster_tmpBpos = getBremsValuesPos_A(temp, seed_eta, seed_phi) ;
...
//eta, phi, seed energy in cluster_tmp; energy and brems in cluster_tmp1
        ...
        RemoveTmp_A(temp, seed_eta, seed_phi, cluster_tmp.brems ) ;
...
void stitchClusters_A(Cluster clusterIn[Nbclusters], Cluster clusterOut[Nbclusters]){
...
void algo_top_A(ap_uint<384> link_in[N_INPUT_LINKS], ap_uint<384> link_out[N_OUTPUT_LINKS]){
#pragma HLS ARRAY_PARTITION variable=link_in complete dim=0
...
processInputLinks_A(link_in, ECALRegion3x4_1, ECALRegion3x4_2, ECALRegion3x4_3);
...
//
        sort_clusterIn[0] = getRegion3x4_A(ECALRegion3x4_1, 9);
        sort_clusterIn[1] = getRegion3x4_A(ECALRegion3x4_1, 9);
        sort_clusterIn[2] = getRegion3x4_A(ECALRegion3x4_1, 9);
        sort_clusterIn[3] = getRegion3x4_A(ECALRegion3x4_1, 9);

        sort_clusterIn[4] = getRegion3x4_A(ECALRegion3x4_2, 12);
        sort_clusterIn[5] = getRegion3x4_A(ECALRegion3x4_2, 12);
        sort_clusterIn[6] = getRegion3x4_A(ECALRegion3x4_2, 12);
        sort_clusterIn[7] = getRegion3x4_A(ECALRegion3x4_2, 12);

        sort_clusterIn[8] = getRegion3x4_A(ECALRegion3x4_3, 15);
        sort_clusterIn[9] = getRegion3x4_A(ECALRegion3x4_3, 15);
        sort_clusterIn[10] = getRegion3x4_A(ECALRegion3x4_3, 15);
        sort_clusterIn[11] = getRegion3x4_A(ECALRegion3x4_3, 15);

// stitch clusters
        
        stitchClusters_A(sort_clusterIn, sort_clusterInStitched);

// sorting of clusters, we have now 12 clusters, highest 6 
// will be sent to SLRB, they come last from
// sorter

        bitonicSort16_A(sort_clusterInStitched, sort_clusterOut);
...
// keep only 6 highest clusters, others return back to towers
        ...
        getTowerEt_A(ECALRegion3x4_1, towerEtECAL1);
        getTowerEt_A(ECALRegion3x4_2, towerEtECAL2);
        getTowerEt_A(ECALRegion3x4_3, towerEtECAL3);
